...
def extract_data(data):
    ...
    drug_names = [item.get("title") for item in arm_groups]    # drug_names.extend([None] * (max_drug_count - len(drug_names)))
...
target = "https://clinicaltrials.gov/api/v2/studies/NCT00295620"
...
# Save to CSV
csv_filename = "Output_NCT00295620_test.csv"
