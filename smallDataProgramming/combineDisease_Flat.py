...
main_csv_file_path = 'Valid_SingleGroup_with_DrugId.csv'  # Replace with the path to your main CSV file
main_df = pd.read_csv(main_csv_file_path)

# Load the second CSV file (the one containing NCT numbers and Drug IDs)
additional_csv_file_path = 'Disease_Drug_trials_SingleGroup.csv'  # Replace with the path to your additional CSV file
additional_df = pd.read_csv(additional_csv_file_path)

output_csv_path = 'Valid_SingleGroup_with_DrugId_and_Disease.csv'  # Replace with your desired output file path
